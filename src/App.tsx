...
//     setIsAnalyzing(true);
//     setError(null);
//     setStatusMessage("Analyzing AST…");
...
//       }}
//       className="flex flex-col h-screen w-screen overflow-hidden bg-[#07080a] text-slate-100 font-sans selection:bg-black selection:text-white"
//     >
//       {/* ── CLEAN WORKBENCH HEADER (TABS ON RIGHT BEFORE ANALYZE) ── */}
//       <header className="h-12 px-2.5 sm:px-4 border-b border-white/[0.08] bg-[#050608] flex items-center justify-between gap-2 shrink-0 z-30 select-none">
//         {/* Left: Brand & File System */}
...
//               }}
//               className="h-7 px-2 rounded-md text-[10px] font-mono font-semibold uppercase bg-white/[0.03] hover:bg-white/[0.06] border border-white/[0.08] hover:border-white/20 flex items-center gap-1 text-slate-400 hover:text-slate-200 transition"
//             >
//               <span className="max-w-[48px] sm:max-w-none truncate">{activeFile.language}</span>
...
//                 className="absolute top-full left-0 mt-1.5 w-40 max-h-60 overflow-y-auto rounded-xl bg-[#0b0d12] border border-white/15 shadow-2xl p-1 z-50 divide-y divide-white/[0.04]"
//               >
...
//         {/* Right Section: Tabs Pill Group + Primary Action */}
...
//               className={`px-2 sm:px-2.5 py-1 rounded-md font-mono text-[10px] sm:text-[11px] font-bold flex items-center gap-1 transition ${
//                 activeTab === "editor"
...
//             className="flex items-center gap-1.5 px-3 sm:px-4 h-7 sm:h-8 rounded-lg bg-white text-black font-mono font-bold text-[10px] sm:text-xs tracking-wider uppercase hover:bg-slate-200 active:scale-95 transition shadow-lg shrink-0"
//           >
//             {isAnalyzing ? (
//               <>
...
//         {/* Right Section: Viewport Tab Switches + Analyze Trigger */}
//         <div className="flex items-center gap-2 shrink-0">
//           <div className="flex items-center p-0.5 rounded-lg bg-white/[0.04] border border-white/[0.08]">
//             <button
//               onClick={() => setActiveTab("editor")}
