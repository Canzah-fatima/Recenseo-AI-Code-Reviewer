...
//       <div className="h-full flex flex-col items-center justify-center p-6 text-center select-none text-zinc-500 bg-[#07090D]">
//         <div className="w-10 h-10 rounded-2xl bg-white/[0.02] border border-white/[0.08] flex items-center justify-center mb-3 text-zinc-400">
//           <Braces size={22} className="text-zinc-400" />
//         </div>
//         <h3 className="text-sm font-semibold text-zinc-200 mb-1">
//           Ready for telemetry
//         </h3>
...
//                         <span
//                           className={`font-mono text-[8px] px-1.5 py-0.5 rounded uppercase font-bold shrink-0 ${
//                             isCritical
//                               ? "bg-rose-500/10 text-rose-400 border border-rose-500/20"
//                               : isWarning
//                               ? "bg-amber-500/10 text-amber-400 border border-amber-500/20"
...
export default function AnalysisPanel({
  ...
  if (isAnalyzing) {
    return (
      <div className="h-full w-full flex flex-col items-center justify-center p-6 text-center select-none bg-[#07090D]">
        <div className="w-8 h-8 border-2 border-white/20 border-t-white rounded-full animate-spin mb-3" />
        <span className="font-mono text-xs font-bold tracking-widest text-white uppercase">
          Traversing AST Nodes…
        </span>
  ...
  if (error) {
    return (
      <div className="h-full w-full flex flex-col items-center justify-center p-6 text-center select-none bg-[#07090D] animate-in fade-in">
        <div className="w-10 h-10 rounded-full border border-rose-500/30 bg-rose-500/10 flex items-center justify-center mb-3 text-rose-400">
          <AlertCircle size={20} />
        </div>
        <h3 className="text-sm font-mono font-bold tracking-wider text-rose-300 uppercase mb-2">
  ...
  if (!analysis) {
    return (
      <div className="h-full w-full flex flex-col items-center justify-center p-6 text-center select-none text-zinc-500 bg-[#07090D]">
        <div className="w-10 h-10 rounded-2xl bg-white/[0.02] border border-white/[0.08] flex items-center justify-center mb-3 text-zinc-400">
          <Braces size={22} className="text-zinc-400" />
        </div>
        <h3 className="text-sm font-semibold text-zinc-200 mb-1">
  ...
  return (
    <div className="relative h-full w-full flex flex-col overflow-hidden bg-[#07090D]">
      {/* ── SUB-HEADER: ACTION BAR & STATUS ── */}
      <div className="h-9 px-3 sm:px-4 border-b border-white/[0.06] bg-[#050608] flex items-center justify-between font-mono text-[10px] tracking-wider shrink-0 select-none">
        {activeTab === "diagnostics" && metrics && (
          <div className="flex items-center gap-3">
      ...
      <div className="flex-1 flex flex-col overflow-y-auto pb-14">
        ...
        {/* TAB 3: DIFF (TRUE HORIZONTAL & VERTICAL CENTERING) */}
        {activeTab === "diff" && (
          <div className="w-full flex-1 min-h-[360px] flex flex-col font-mono text-[11px] sm:text-xs">
            {!hasChanges ? (
              <div className="flex-1 w-full flex flex-col items-center justify-center p-6 text-center select-none text-zinc-400 my-auto animate-in fade-in zoom-in-95 duration-200">
                <div className="w-12 h-12 rounded-full border border-emerald-500/30 bg-emerald-500/10 flex items-center justify-center mb-4 text-emerald-400 shadow-[0_0_16px_rgba(52,211,153,0.15)]">
